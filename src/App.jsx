...
function App() {
  ...
  return (
    ...
    <header className="max-w-2xl mx-auto px-6 pt-16">
      <h1 className="text-4xl font-semibold tracking-tight">Shane Nathan B. Archival</h1>
    ...
    <main className="max-w-2xl mx-auto px-6 py-10">
      ...
      <section className="mb-10">
        ...
        <p className="leading-relaxed text-slate-700">
          I grew up in Labangon and started school in Labangon Elementary School. I picked IT because I
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc list-inside space-y-1 text-slate-700">
          ...
          <li>Eating delcious food with my friends or family</li>
      ...
      <section>
        ...
        <p className="leading-relaxed text-slate-700">
          shane.archival@cit.edu
          <br/>
          @shanearchival on most things
        </p>
      </section>
